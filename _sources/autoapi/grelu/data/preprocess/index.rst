...
.. py:function:: filter_blacklist(data: Union[pandas.DataFrame, anndata.AnnData], genome: str, blacklist: Optional[str] = None, inplace: bool = False, window: int = 0)
   ...
   :param blacklist: path to blacklist file. If not given, will be
...
.. py:function:: get_gc_matched_intervals(intervals: pandas.DataFrame, genome: str, binwidth: float = 0.1, chroms: str = 'autosomes', gc_bw_file: str = None, blacklist: str = 'hg38', seed: Optional[int] = None) -> pandas.DataFrame
   ...
   :param gc_bw_file: Path to a bigWig file of genomewide GC content.
                      If None, will be created.
   :param blacklist: Blacklist file of regions to exclude
